...
@TestPropertySource(properties = {
        ...
        "sofrito.rate-limit.confiar-en-proxy=true",
        "sofrito.rate-limit.auth.capacidad=2",
        "sofrito.rate-limit.auth.recarga-por-minuto=2",
        "sofrito.rate-limit.api.capacidad=5",
        "sofrito.rate-limit.api.recarga-por-minuto=5"
})
