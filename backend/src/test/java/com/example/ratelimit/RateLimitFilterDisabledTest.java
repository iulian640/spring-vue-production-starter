...
/**
 * Con {@code app.rate-limit.habilitado=false} el filtro no debe limitar
...
@TestPropertySource(properties = {
        "app.rate-limit.habilitado=false",
        "app.rate-limit.auth.capacidad=1",
        "app.rate-limit.auth.recarga-por-minuto=1"
})
